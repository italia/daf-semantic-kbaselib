...
/**
 * This example should give an idea on how to publish inferred statements/triples on a custom, dedicated graph. 
 * TODO: extract a proper test case showing various combinations, from this example.
 */
